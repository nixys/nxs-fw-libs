...
/** @addtogroup nxs-cfg-json
 *
 * @brief Module 'nxs-cfg-json' is a basic module providing functions to work with json-like configuration files.
 *
 *  @{
 */
...
nxs_cfg_json_state_t		nxs_cfg_json_init			(nxs_process_t *proc, nxs_cfg_json_t *cfg, nxs_string_t *cfg_path, nxs_cfg_json_state_t (*prep_function)(nxs_cfg_json_t cfg), nxs_cfg_json_state_t (*post_function)(nxs_cfg_json_t cfg), nxs_array_t *cfg_arr);
...
void				nxs_cfg_json_conf_array_add		(nxs_array_t *cfg_arr, nxs_string_t *par_name, void *value, nxs_cfg_json_state_t (*proc_function)(nxs_process_t *proc, nxs_json_t *json, nxs_cfg_json_par_t *cfg_json_par), nxs_cfg_json_state_t (*el_prep_function)(nxs_process_t *proc, nxs_json_t *json, nxs_cfg_json_par_t *cfg_json_par, nxs_array_t *cfg_arr), nxs_cfg_json_type_t type, double min_val, double max_val, nxs_bool_t required, nxs_cfg_json_par_t *sub_els);
